#!/usr/bin/env python3
"""
Populate Fabric SQL Database — CIMIC AI Workshop

Populates cimic_sqldb with CIMIC summary data using the Fabric REST API SQL endpoint.
...
SUPPLIERS = [
    ("Boral Construction Materials", "CPB Contractors", "Concrete & Aggregates"),
    ("Holcim Australia", "CPB Contractors", "Cement"),
    ("Liberty Steel", "CPB Contractors", "Structural Steel"),
    ("Coates Hire", "CPB Contractors", "Equipment Rental"),
    ("Orica Mining Services", "Thiess", "Explosives & Blasting"),
    ("Sandvik Mining", "Thiess", "Mining Equipment"),
    ("Caterpillar Australia", "Thiess", "Heavy Equipment"),
    ("Komatsu", "Thiess", "Haul Trucks"),
    ("Weir Minerals", "Thiess", "Wear Parts"),
    ("FLSmidth", "Sedgman", "Processing Equipment"),
    ("Metso Outotec", "Sedgman", "Crushers & Screens"),
    ("Nalco Water", "Sedgman", "Water Treatment"),
    ("Atlas Copco", "Sedgman", "Compressors"),
    ("Siemens Energy", "Sedgman", "Electrical Systems"),
    ("Transurban Materials", "Pacific Partnerships", "Toll Systems"),
    ("AECOM Consulting", "Pacific Partnerships", "Engineering Services"),
    ("John Holland Supply", "CPB Contractors", "Subcontracting"),
    ("Downer EDI", "Thiess", "Site Services"),
    ("Monadelphous", "Sedgman", "Mechanical Services"),
    ("Lendlease Engineering", "Pacific Partnerships", "Joint Venture"),
]
...
def build_full_sql():
    ...
    ddl = """
-- ============================================================
-- CIMIC Fabric SQL Database — Full Population Script
...
def main():
    parser = argparse.ArgumentParser(description="Populate Fabric SQL Database with CIMIC data")
    ...
    if args.workspace_id and args.sqldb_id:
        ...
        try:
            ...
            print(f"  1. Open Fabric portal → SQL Database 'cimic_sqldb'")
