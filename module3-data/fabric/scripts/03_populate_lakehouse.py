#!/usr/bin/env python3
"""
Populate Fabric Lakehouse — CIMIC AI Workshop

Creates pre-aggregated KPI tables in cimic_lakehouse for the Semantic Model.
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Generate Lakehouse KPI tables for CIMIC semantic model")
    ...
    parser.add_argument("--lakehouse-name", default=None,
                        help="Lakehouse name for Spark saveAsTable (env: FABRIC_LAKEHOUSE_NAME, default: cimic_lakehouse)")
    ...
    if not lakehouse_name:
        lakehouse_name = "cimic_lakehouse"
