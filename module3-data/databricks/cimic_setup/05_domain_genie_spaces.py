...
# MAGIC
# MAGIC Creates **5 Genie Spaces** on the `cimic` catalog: one cross-domain intelligence
...
# MAGIC |-------|--------|---------|
# MAGIC | CIMIC Project Intelligence | All 4: `projects.financials`, `safety.incidents`, `equipment.equipment_telemetry`, `procurement.materials` | Cross-domain Operations Intelligence |
...
# MAGIC %md
# MAGIC ## 1. CIMIC Project Intelligence
# MAGIC
        ...
        "tables": sorted([
            {
                ...
                "column_configs": sorted([
                    ...
                    {"column_name": "division", "enable_format_assistance": True, "enable_entity_matching": True, "description": ["Operating division: CPB Contractors, Thiess, Sedgman, Pacific Partnerships"]},
    ...
    "instructions": {
        "text_instructions": [{
            ...
            "content": [
                ...
                f"Divisions: CPB Contractors, Thiess, Sedgman, Pacific Partnerships. ",
...
safety_space = {
    ...
    "config": {
        "sample_questions": [
            ...
            {"id": sq[7], "question": ["Compare safety performance between CPB Contractors and Thiess"]},
        ]
    },
    "data_sources": {
        "tables": [
            {
                ...
                "column_configs": sorted([
                    ...
                    {"column_name": "division", "enable_format_assistance": True, "enable_entity_matching": True,
                     "description": ["Operating division: CPB Contractors, Thiess, Sedgman, Pacific Partnerships"]},
                    {"column_name": "incident_type", "enable_format_assistance": True, "enable_entity_matching": True,
    ...
    "instructions": {
        "text_instructions": [{
            ...
            "content": [
                ...
                f"Divisions: CPB Contractors (infrastructure), Thiess (mining services), Sedgman (mineral processing), Pacific Partnerships (PPPs)."
            ]
        }],
        "example_question_sqls": sorted([
        ...
        "tables": [
            {
                ...
                "column_configs": sorted([
                    ...
                    {"column_name": "supplier", "enable_format_assistance": True, "enable_entity_matching": True,
                     "description": ["Supplier company name, e.g. BlueScope Steel, Boral, Hanson, Holcim"]},
        ...
        "tables": [
            {
                ...
                "description": [
                    ...
                    f"Covers all {customer} divisions: CPB Contractors (infrastructure), Thiess (mining), "
                    "Sedgman (mineral processing), Pacific Partnerships (PPPs)."
                ],
                "column_configs": sorted([
    ...
    "instructions": {
        "text_instructions": [{
            ...
            "content": [
                ...
                f"Divisions: CPB Contractors (major infrastructure — roads, rail, tunnels), Thiess (contract mining services), Sedgman (mineral processing plants), Pacific Partnerships (PPP concessions)."
            ]
        }],
        "example_question_sqls": sorted([
