...
if group_style == "customer-division":
    DIVISION_GROUPS = {
        "CPB Contractors": f"{customer}-Division-CPB",
        "Thiess": f"{customer}-Division-Thiess",
        "Sedgman": f"{customer}-Division-Sedgman",
    }
    exec_group = f"{customer}-Division-Executives"
else:
    DIVISION_GROUPS = {
        "CPB Contractors": "Group-A",
        "Thiess": "Group-B",
        "Sedgman": "Group-C",
    }
...
if apply_grants_flag:
    ...
    # (Pacific Partnerships data remains unfiltered/shared in these tables)
    shared_tables = [
